...
class Management_Type(models.Model):
    ...
    Campaign = models.CharField(max_length=20, null=True,blank=True)
...
class Payroll_Client(models.Model):
    ...
    Law_Applies = models.CharField(max_length=20, null=True,blank=True)
...
class Right_Petition(models.Model):
    ...
    Process_State = models.CharField(max_length=20, null=True,blank=True)
    ...
    Court = models.CharField(max_length=20, null=True,blank=True)
...
class Disbursement(models.Model):
    ...
    Banking_Entity = models.CharField(max_length=20, null=True,blank=True)
...
class Financial_Obligation(models.Model):
    Payroll = models.CharField(max_length=100, null=False,blank=True)
