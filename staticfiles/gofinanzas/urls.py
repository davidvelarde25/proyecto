...
urlpatterns = [
    ...
    path('listarcliente/', views.ClientView.as_view(), name= 'listarcliente'),# ruta pra mostrar todos los clientes
    path('editarcliente/<int:pk>/', views.ClientUpdate.as_view(), name='editarcliente'), # ruta para actualizar un cliente especifico

    path('creargestion/<int:pk>/', views.ManagementTypeCreate.as_view(), name="creargestion"), # ruta para crear la gestion de un cliente
    path('listargestion/<int:pk>/', views.ManagementTypeView.as_view(), name="listargestion"), # ruta para listar la gestion de un cliente
    ...
    path('crearreferencia/<int:pk>/', views.ReferenceCreate.as_view(), name="crearreferencia"), # ruta para crear las referencias de los cliente
    path('listarreferencia/<int:pk>/', views.ReferenceView.as_view(), name= 'listarreferencia'),# ruta pra mostrar las referencias registrados de cada cliente
    ...
    path('crearobligacion/<int:pk>/', views.FinancialObligationCreate.as_view(), name="crearobligacion"), # ruta para crear las obligaciones de los clientes
    path('listarobligacion/<int:pk>/', views.FinancialObligationView.as_view(), name= 'listarobligacion'),# ruta pra mostrar las Obligaciones registrados de cada cliente
    ...
    path('crearcertificado/<int:pk>/', views.CertificateCreate.as_view(), name="crearcertificado"), # ruta para crear el certificado de cada na de las obligaciones
    path('listarcertificado/<int:pk>/', views.CertificateView.as_view(), name= 'listarcertificado'),# ruta pra mostrar las certificados registrados de cada cliente
    ...
    path('crearderechopeticion/<int:pk>/', views.RightPetitionCreate.as_view(), name="crearderechopeticion"), # ruta para crear el certificado de cada na de las obligaciones
    path('listarderechopeticion/<int:pk>/', views.RightPetitionView.as_view(), name= 'listarderechopeticion'),# ruta pra mostrar las derechos de peticion registrados de cada cliente
    ...
    path('crearcuenta/<int:pk>/', views.BankAccountsCreate.as_view(), name="crearcuenta"), # ruta para crear las cuentas bancarias de los clientes
    path('listarcuenta/<int:pk>/', views.BankAccountsView.as_view(), name= 'listarcuenta'),# ruta pra mostrar las derechos de peticion registrados de cada cliente
    ...
    path('creardesembolso/<int:pk>/', views.DisbursementCreate.as_view(), name="creardesembolso"), # ruta para crear las desembolsos  de los clientes
    path('listardesembolso/<int:pk>/', views.DisbursementView.as_view(), name= 'listardesembolso'),# ruta pra mostrar las desembolsos registrados de cada cliente
    ...
    path('accounts', include('django.contrib.auth.urls')),# url para
