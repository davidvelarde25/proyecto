...
from .models import Reference,Disbursement,Management_Type, Payroll_Client, Certificate, Right_Petition, Bank_Accounts, Disbursement, Financial_Obligation,Client,Advisor_Records, Actual_State,Customer_Referrer,Simulation_Banking
...
admin.site.register(Simulation_Banking)
